<template>
  <h-layout-single :max-width="1280" class="layout">
    ...
    <div class="settings-content">
      <a-space>
        ...
        <a-input
          v-model:value="picName"
          :placeholder="``"
          style="min-width: 100px" />
        <a-select v-model:value="chosenPicType" style="width: 90px">
...
import {
  CodeEditorLanguagesDisplayName,
  CodeEditorLanguagesUnion,
